...
internal struct SavedConstraint5 : ISavedConstraint<SavedConstraint5>
{
    ...
    {
        if (obj is not SavedConstraint5 sc) return false;

        return this == sc;
    }
    public override int GetHashCode() => base.GetHashCode();

    public bool Equals(SavedConstraint5 other)
    {
        return this == other;
    }

    public static bool operator ==(SavedConstraint5 sc1, SavedConstraint5 sc2)
    {
#if DEBUG
    ...
    public static bool operator !=(SavedConstraint5 sc1, SavedConstraint5 sc2) => !(sc1 == sc2);
}
